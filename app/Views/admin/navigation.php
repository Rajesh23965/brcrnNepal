...
<form action="<?php echo base_url() . 'Admin/Admincontroller/save_navigation' ?>" method='post'
        ...
        <div class='card-body'>
                ...
                <div class="col">
                    ...
                    <div class='col customColumn dd-none'>
                        ...
                        <div class='d-flex align-center'>
                            <input id="custom_field" type='text' name='custom_field' class='form-control'
                                placeholder="Enter Navigation Title">
                            <input id="custom_url" type="text" name="custom_url" class="form-control mx-2"
            ...
            <div class='row'>
                ...
                <div class='alert alert-error text-danger d-flex bold'>
                    <?php echo 'Image not uploaded.'.' '.$this->session->flashdata( 'error' ).'  '.'Please try adding again';
?>
                </div>
                <?php endif;
?>
...
foreach ( $nav_list as $nl ) : $i++ ?>
                    <tr>
                        ...
                        <td><?php if ( !empty( $nl[ 'page_title' ] ) ) : echo $nl[ 'page_title' ];elseif($nl['custom_field']):?><a
                                href="<?php if(!empty($nl['custom_url'])): echo $nl['custom_url']; endif?>"><?php echo $nl['custom_field'];?></a><?php endif ?>
                        </td>
                        ...
                        <td>
                            ...
                            <a class='text-danger' href="<?php if ($nl['nav_id']) : echo base_url() . 'admin/Admincontroller/delete_nav_list/' . $nl['nav_id'];
